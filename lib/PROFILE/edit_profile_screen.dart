...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  late List<String> listOfCategory=[
    "Spear1","Line Fishing1",
    "Spear2","Line Fishing2",
    "Spear3","Line3",
    "Spear4","Line Fishing3",
    "Spear5","Line4",
    "Spear6","Line Fishing4",
  ];
  @override
                  ...
                  children: [
                    ...
                    const Text(
                      'Categories',style: TextStyle(
                        fontSize: 18,fontFamily: 'Rodetta',
                        color: secondaryColor,
                      ...
                      List.generate(
                          listOfCategory.length  ,
                            ...
                            decoration:  BoxDecoration(
                              color: selectedCategories.contains(listOfCategory[index]) ? secondaryColor : btnColor,
                            ...
                            child:  InkWell(
                              ...
                              onTap: (){
                                setState(() {
                                  if(selectedCategories.contains(listOfCategory[index])){
                                    selectedCategories.remove(listOfCategory[index]);
                                  }else{
                              ...
                              child: Padding(
                                ...
                                child: CustomText(text: listOfCategory[index],
                                  sizeOfFont: 16,
                                  weight: FontWeight.w700,
                                  color: selectedCategories.contains(listOfCategory[index]) ? fishColor: primaryColor,
                                ),
                              ),
                            ),
                          )),
